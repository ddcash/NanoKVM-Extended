  ...
  translation: {
    ...
    settings: {
      ...
      actions: {
        ...
        modeToggle: 'Toggle',
        addStep: 'Add step',
        pwmEnable: 'Enable output',
        pwmHint:
          'Period in nanoseconds: around 1000000 (1kHz) suits an LED, 20000000 (20ms) suits a servo.',
        commandBackground: 'Run in background',
        timeout: 'Timeout',
        doublePress: 'Double press',
        veryLongPress: 'Very long press',
        typeCommand: 'Command',
        modePulse: 'Pulse',
        modeHigh: 'Set high',
        modeLow: 'Set low',
        ...
        keepDefaultsDesc:
          'The built-in behaviour is always kept: OLED paging, Wi-Fi setup and hold-to-reset-password keep working, and a custom action runs alongside rather than replacing them. A very long press still resets the password.',
        none: 'Nothing',
        save: 'Save',
        saved: 'Saved',
      ...
      account: {
        ...
        sessionsDesc:
          'Every browser signed in to this device. Revoking one signs it out immediately.',
        sessionCurrent: 'This browser',
        sessionLastSeen: 'last seen',
        sessionRevoke: 'Revoke',
        sessionRevokeAll: 'Revoke others',
        sessionRevokeConfirm: 'Sign this session out?',
        sessionRevokeAllConfirm: 'Sign out every other session?',
        sessionRevoked: 'Session revoked',
        sessionRevokeFailed: 'Failed to revoke',
